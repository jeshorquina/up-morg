...
--
-- Host: localhost:3306
-- Generation Time: Apr 11, 2017 at 01:05 AM
-- Server version: 5.7.17-0ubuntu0.16.10.1
-- PHP Version: 7.0.17-3+deb.sury.org~yakkety+1
...
(1, 1, 'a', 'a', '2010-10-10', '22:10:00', '2017-04-10 16:53:35', 0);
...
--
ALTER TABLE `BatchMember`
  MODIFY `BatchMemberID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `StaticData`
  MODIFY `StaticDataID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `Task`
--
ALTER TABLE `Task`
  MODIFY `TaskID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `TaskStatus`
  MODIFY `TaskStatusID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `CommitteeMember`
  ADD CONSTRAINT `FK_CommiteeMember_CommiteeID` FOREIGN KEY (`CommitteeID`) REFERENCES `Committee` (`CommitteeID`),
...
--
ALTER TABLE `CommitteePermission`
  ADD CONSTRAINT `FK_CommiteePermission_CommiteeID` FOREIGN KEY (`CommitteeID`) REFERENCES `CommitteePermission` (`CommitteePermissionID`),
