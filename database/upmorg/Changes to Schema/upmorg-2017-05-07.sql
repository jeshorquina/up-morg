...
CREATE TABLE `TaskSubmission` (
  ...
  `TaskID` int(10) unsigned NOT NULL,
  `BatchMemberID` int(10) unsigned NOT NULL,
  `IsFile` bit(1) NOT NULL DEFAULT b'0',
  `Value` varchar(511) NOT NULL,
  PRIMARY KEY (`TaskSubmissionID`),
  KEY `FK_TaskSubmission_TasKID_idx` (`TaskID`),
  KEY `fk_TaskSubmission_BatchMemberID_idx` (`BatchMemberID`),
  CONSTRAINT `FK_TaskSubmission_BatchMemberID` FOREIGN KEY (`BatchMemberID`) REFERENCES `BatchMember` (`BatchMemberID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `TaskSubscriber` VALUES (13,9,75),(14,9,72),(15,9,73),(16,9,74),(17,10,72),(18,10,82),(19,10,73),(20,11,76),(21,11,84),(22,11,83),(23,11,73),(24,12,75),(25,12,88),(30,15,72),(31,16,76),(32,16,75),(33,16,72),(34,17,76),(35,17,75),(36,17,72),(37,17,73),(44,22,72),(45,22,82),(50,22,88),(51,22,75),(58,26,88),(59,26,75),(68,32,72),(69,32,88),(70,32,75),(71,33,88),(72,33,75),(73,34,75),(74,34,88),(75,34,72),(76,11,72);
...
INSERT INTO `TaskTree` VALUES (1,15,9),(2,16,9),(3,17,9),(7,22,12),(11,26,12);
...
-- Dump completed on 2017-05-07 15:43:44
